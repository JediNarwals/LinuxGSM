...
cmd_start=( "st;start" "command_start.sh; alert='start'; alert.sh" "Start the server." )
cmd_stop=( "sp;stop" "command_stop.sh; alert='stop'; alert.sh" "Stop the server." )
cmd_restart=( "r;restart" "command_restart.sh; alert='restart'; alert.sh" "Restart the server." )
