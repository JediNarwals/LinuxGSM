...
cmd_update_missions=( "um;update-missions" "cd ${serverfiles}; svn merge https://github.com/${githubmissionusr}/${githubmissionsrepo}/${githubmissionsbranch}/${githubmissionsfiles}" "Check and apply any mission updates from Github." )
