...
cmd_update_missions=( "um;update-missions" "cd ${serverfiles};  svn checkout https://github.com/${githubmissionusr}/${githubmissionsrepo}/${githubmissionsbranch}/${githubmissionsfiles}" "Check and apply any mission updates from Github." )
