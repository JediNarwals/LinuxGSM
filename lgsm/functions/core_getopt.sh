...
cmd_update_missions=( "um;update-missions" "./arma3server stop; rm -r ${missionsfile}/.svn/ ; cd ${serverfiles}; svn checkout https://github.com/${githubmissionusr}/${githubmissionsrepo}/${githubmissionsbranch}/${githubmissionsfiles}; ./arma3server start" "Check and apply any mission updates from Github." )
